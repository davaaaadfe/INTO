...
export const exactOnlineConnections = sqliteTable(
  ...
  (table) => [uniqueIndex("exact_online_connections_user_idx").on(table.userId)]
);
...
export const exactMasterDataCaches = sqliteTable(
  ...
  (table) => [
    uniqueIndex("exact_master_data_caches_user_division_idx").on(
      table.userId,
      table.divisionCode
    ),
...
export const outlookConnections = sqliteTable(
  ...
  (table) => [uniqueIndex("outlook_connections_user_idx").on(table.userId)]
);
...
export const usersRelations = relations(users, ({ many }) => ({
  ...
  exactConnections: many(exactOnlineConnections),
  outlookConnections: many(outlookConnections),
